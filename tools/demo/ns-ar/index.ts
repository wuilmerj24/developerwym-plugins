...
import { AR, ARLoadedEventData, ARMaterial, ARNodeInteraction, ARPlaneDetectedEventData, ARPlaneTappedEventData, ARSceneTappedEventData, ARTrackingFaceEventData, ARTrackingImageDetectedEventData, ARVideoNode } from "@developerwym/ns-ar";
import { Observable, Page, isIOS, Image, Color } from "@nativescript/core";

export class DemoSharedNsAr extends DemoSharedBase {
